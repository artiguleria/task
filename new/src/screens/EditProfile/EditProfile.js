...
const EditProfie = ({navigation, route}) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.log('date of birth  is ' + body.dob);
      console.log('gender ' + body.gender_id);
      console.log('country is  ' + body.rp_gbl_country_id);
      console.log('total exp is ' + body.total_experience_id);
      console.log('hoe long present ' + body.present_experience_id);
      console.log('employee status is ' + body.employee_status_id);
